...
function DotLottieComponent(_a) {
  ...
  return import_react.default.createElement("div", __spreadValues({ ref: setContainerRef, className }, !className && { style: containerStyle }), import_react.default.createElement(
    "canvas",
    __spreadValues({
      ref: setCanvasRef,
      style: {
...
var useDotLottie = (config) => {
  ...
  const Component = (0, import_react.useCallback)(
    (props) => {
      return import_react.default.createElement(DotLottieComponent, __spreadValues({ setContainerRef, setCanvasRef }, props));
    },
...
var DotLottieReact = (_a) => {
  ...
  return import_react.default.createElement(DotLottieComponent2, __spreadValues({}, props));
};
...
var useDotLottieWorker = (config) => {
  ...
  const Component = (0, import_react.useCallback)(
    (props) => {
      return import_react.default.createElement(DotLottieWorkerComponent, __spreadValues({ setContainerRef, setCanvasRef }, props));
    },
    [setCanvasRef, setContainerRef]
  );
  (0, import_react.useEffect)(() => {
